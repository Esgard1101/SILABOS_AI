        ...
        return json.dumps(
            {
                ...
                "rules": [
                    ...
                    "PROHIBIDO inventar nombres propios de colegios, instituciones, empresas u organizaciones especificas: no puedes verificar que existan. Solo los distritos/lugares del contexto territorial pueden nombrarse; para instituciones usa referencias genericas ('colegios publicos del distrito', 'una asociacion de productores de la zona').",
        ...
        *,
        ...
        prompt_payload = {
                ...
                "rules": [
                    ...
                    "PROHIBIDO inventar nombres propios de colegios, instituciones, empresas u organizaciones especificas: solo los distritos/lugares del contexto territorial pueden nombrarse. Para instituciones usa referencias genericas ('colegios publicos del distrito', 'un centro de salud de la zona').",
