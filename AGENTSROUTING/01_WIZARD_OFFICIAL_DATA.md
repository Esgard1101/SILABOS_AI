...
- (SPEC-11) NotebookLM roadmap (`Step2A_NotebookGuide.tsx`) is a **vertical timeline of 5 steps** (Crear cuaderno / Agregar fuentes with Carga manual + Deep Research tabs / Verificar fuentes / Ajustar chat / Traer fuentes a SIGEISIL), each markable as done (local state, green check, cyan connector). Do not go back to grids/2-row card layouts or color legends.
